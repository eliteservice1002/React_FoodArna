                            ...
                            <Paper>
                                <ClickAwayListener onClickAway={handleClose}>
                                    <MenuList autoFocusItem={open} style={{ display: 'flex', flexDirection: 'column', padding: '10px' }} id="menu-list-grow" onKeyDown={handleListKeyDown}>
                                        ...
                                        <MenuItem onClick={handleClose8}>Teach</MenuItem>
                                        <MenuItem onClick={handleClose9}>Sell Online</MenuItem>
                                        <MenuItem onClick={handleClose10}>Culinary Event</MenuItem>
                                        <MenuItem onClick={handleClose11}>Share or Gift</MenuItem>
                                    </MenuList>
                                </ClickAwayListener>
                            </Paper>
                        </Grow>
...
export default connect(mapStateToProps)(DropMenu1);